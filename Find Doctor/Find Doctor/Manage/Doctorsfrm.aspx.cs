...
public partial class Manage_Teachersfrm : System.Web.UI.Page
{
    ...
    {
        Response.Redirect("AddDoctor.aspx?ID=" + ServicesData.SelectedValue.ToString());
    }
    void DelDept(int ID)
    {
        DataClassesDataContext db = new DataClassesDataContext();
        Doctor doctor = db.Doctors.Single(p => p.DoctorID == ID);
