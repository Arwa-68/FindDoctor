...
$(document).ready(function () {
    ...
    var DayDateSelected;
    $.ajax({
        url: "HotelSystem.svc/GetReservationData?frm=1/1/2000&to=1/1/2000" , success: function (result2) {
            debugger;
            sources = result2.d;
                ...
                CalendarData =    $('#calendar1').fullCalendar({
                   ...
                   // defaultDate: d,
                    ...
                    viewRender: function (view) {
                        ...
                        $.ajax({
                            url: "HotelSystem.svc/GetReservationData?frm=" + frm+"&to="+to, success: function (result2) {
                                debugger;
